...
import IOSZoneCard from './IOSZoneCard';
import IOSZoneModal from './IOSZoneModal';
  ...
  return (
    <div className="ios-dashboard">
      {floors.map(floor => {
        ...
        return (
          <section key={floor.level} className="ios-floor">
            <h2 className="ios-floor__title">{floor.name}</h2>

            <div className="ios-zone-grid">
              {/* HVAC Zones */}
